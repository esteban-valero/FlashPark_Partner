...
import 'package:hello_world_flutter/Model/PlacePrediction.dart';

import 'package:flutter/material.dart';
import 'package:hello_world_flutter/Services/ConfigMaps.dart';
import 'package:hello_world_flutter/utils/text_styles.dart';
import 'package:hello_world_flutter/widgets/Divider.dart';
  ...
  void getPlacesAddressDetails(String placeId, context) async {
    showDialog(
        ...
        builder: (BuildContext context) => AlertDialog(
            title: Text("seleccionando ubicacion, por favor espere")));
    ...
    if (res["status"] == "OK") {
      ...
      print("this is lat");
      print(address.latitud);
      print("this is long");
      print(address.longitud);
